...
const createUser = (user) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [result] = yield dbConfig_1.default.execute('INSERT INTO users (email, password, role) VALUES (?, ?, ?)', [user.email, user.password, user.role]);
...
const findUserById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [rows] = yield dbConfig_1.default.execute('SELECT * FROM users WHERE id = ?', [id]);
        if (Array.isArray(rows) && rows.length > 0) {
