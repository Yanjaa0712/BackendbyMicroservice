...
const createFood = (name, price) => __awaiter(void 0, void 0, void 0, function* () {
    const [result] = yield dbConfig_1.default.execute('INSERT INTO foods (name, price) VALUES (?, ?)', [name, price]);
    return result;
});
